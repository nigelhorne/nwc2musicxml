...
# Source:  return exists $METADATA_EVENT_TYPES{ $self->{_type} };
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  return _reduce_rational(_add_rationals($r1, $r2));
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  return sprintf $MESSAGES{$key}, @args;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_306_18 line 306 in start_time() ---
# Source:  sub start_time { return $_[0]->{_start_time} }
